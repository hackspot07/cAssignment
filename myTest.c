...
void test_concanate_array1_array2__as_result_array(){
	int a []={1,2},b[]={2,3};
	int *result_array;
...
void test_slice_the_array1_which_gives_the_array_from_2_to_5(){
...
void test_slice_the_array1_which_gives_the_array_from_0_to_3_if_slice_with_minus6_4(){
...
void test_give_the_4_numberOfprimes_between_2_to_1000(){
	int start=1,end=10,*result_array;
...
void test_give_the_4_numberOfprimes_between_2_to_5000(){
	int start=1,end=10,*result_array;
...
void test_give_the_4_numberOfprimes_between_2_to_15000(){
	int start=1,end=10,*result_array;
...
void test_gives_the_raja_and_rani_are_not_same(){
	char *str1="reja",*str2="rani";
	assertEqual(stringCompare(str1,str2),4);
	assertEqual(stringCompare(str2,str1),-4);
};

void test_gives_hellllllllllloooo_and_hello_difference_is(){
...
void test_filter_return_lenth_3(){
	char **result_array;
...
void test_map_returns_double_of_each_element(){
...
void test_floatmap_returns_double_of_each_element(){
...
void test_reduceString_it_retunr_the_concanate_string(){
...
void test_reduceChar_it_return_Thello(){
...
void test_stringindexOf_will_return_the_1_index_of_rma(){
	char* string = "parmatma";
	char* substring = "rma";
	int index;
...
void test_stringindexOf_will_return_the_minus_1_index_of_ram(){
	char* string = "hello";
	char* substring = "lo";
	int index;
	index = stringindexOf(string,substring);
